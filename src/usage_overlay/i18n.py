TEXT = {
    "en": {
        ...
        "resets": "Resets {time}", "updated": "Last updated {time}", "refresh_interval": "Refresh interval", "seconds": "s",
    ...
    "zh": {
        ...
        "resets": "{time} 重置", "updated": "最后更新：{time}", "refresh_interval": "刷新间隔", "seconds": "秒",
