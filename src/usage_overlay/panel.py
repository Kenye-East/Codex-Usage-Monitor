...
from usage_overlay.formatting import asset_path, format_reset, icon_name, remaining, ui_font_family
...
class PanelApp(ctk.CTk):
    ...
    def _build_usage_frame(self) -> None:
        ...
        self.session_row = self._build_usage_row(frame, 102, "session_title")
        self.weekly_row = self._build_usage_row(frame, 176, "weekly_title")
