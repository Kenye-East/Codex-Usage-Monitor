...
from usage_overlay.panel import PANEL_HEIGHT, PANEL_WIDTH, TOOLTIP_BG, TOOLTIP_RESET_HIGHLIGHT, TOOLTIP_TEXT, USAGE_HEADER_LINE_HEIGHT, USAGE_HEADER_LINE_GAP, badge_text, format_post_time, full_post_text, notice_empty_state_bounds, notice_empty_state_placement, reset_spans, tooltip_content_size
